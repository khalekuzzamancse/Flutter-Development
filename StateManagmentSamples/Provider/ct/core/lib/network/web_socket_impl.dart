...
//@formatter:off
  ...
  Future<void> connectTry(String url) async {
    ...
    try {
      ...
      //showSnackBar('Failed to connect, make sure url is valid or connected to internet');
  ...
  ///As result maintaining the single local of truth of notified about closing as well as this place can be
  ...
  Future<WebSocketChannel> _connectOrThrow(String url) async {
    ...
    try {
      ...
      // const String wsUrl = "wss://psa1.paymentsave.co.uk/ws/v1/pos/?api-key=a03bdd29-afec-4f1f-ba9e-c82c23b28aa1&api-version=v1&software-house-id=V7BYZNI7&device-uid=T1R236HN";
  ...
  void sentEventOrThrow(String message) {
    ...
    try{
      Logger.on(tag, 'sentEventRequest with data=$message');
