...
import '../../../../core/ui/file_downloader.dart';
...
class _State extends State<CoreChatScreenWithPermission> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      Logger.debug('CoreChatScreen', 'hasMediaPickPermission:$hasPermission');
      return CoreChatScreen(
          ...
          onMediaPickRequest: () async {
            ...
            if (notGranted && context.mounted) {
              Navigation.push(context, MediaPermissionScreen(controller: permissionController));
            }
          },
          model: widget.model,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Text(
          time,
          style: const TextStyle(fontSize: 13.0, color: AppColor.headingText),
        ),
        if (isAmSender)
          Row(
            children: [
      ...
      children: [
        Container(
          ...
          child: Row(
            children: [
              IconButton(
                icon: _isEmojiPickerVisible?const Icon(
                  Icons.keyboard_outlined,
                  color: AppColor.messageAction,
                ):
                const Icon(
              ...
              IconButton(
                icon: const Icon(Icons.attach_file, color: AppColor.messageAction),
                onPressed: () {
